                ...
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('currency_code') is-invalid @enderror" name="currency_code" value="{{ $edit_data->currency_code ?? 'USD' }}" id="currency_code" placeholder="Enter currency code or select below">
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('currency_symbol') is-invalid @enderror" name="currency_symbol" value="{{ $edit_data->currency_symbol ?? '$' }}" id="currency_symbol" placeholder="Enter symbol or select below">
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Select</button>
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="#" onclick="document.getElementById('currency_symbol').value='د.إ'; return false;">د.إ - Dirham</a>
                                        <a class="dropdown-item" href="#" onclick="document.getElementById('currency_symbol').value='৳'; return false;">৳ - Taka</a>
                                        <a class="dropdown-item" href="#" onclick="document.getElementById('currency_symbol').value='₹'; return false;">₹ - Rupee</a>
                                        <a class="dropdown-item" href="#" onclick="document.getElementById('currency_symbol').value='¥'; return false;">¥ - Yen</a>
                                        <a class="dropdown-item" href="#" onclick="document.getElementById('currency_symbol').value='元'; return false;">元 - Yuan</a>
                                        <a class="dropdown-item" href="#" onclick="document.getElementById('currency_symbol').value='Fr'; return false;">Fr - Franc</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('currency_name') is-invalid @enderror" name="currency_name" value="{{ $edit_data->currency_name ?? 'US Dollar' }}" id="currency_name" placeholder="Enter name or select below">
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Select</button>
                                    <div class="dropdown-menu">
